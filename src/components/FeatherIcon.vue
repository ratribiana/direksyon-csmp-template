...
export default {
  ...
  render (h, {props, data}) {
    ...
    const badgeEl = h('span', {class: `feather-icon-badge bg-${props.badgeClass} text-white h-5 w-5 absolute rounded-full text-xs flex items-center justify-center`, style: 'top: -7px; right: -5px'}, [props.badge])
    const children = [svg]
